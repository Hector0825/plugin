Draw.loadPlugin(function(ui){
	...
	function cargar(){
		...
		fs.writeFile("/Users/mpoveda/tmpXml.xml", final, function(err) {
		}); 	
	...
	function execute(command, callback) {				
	    var a = exec('curl -F data=@/Users/mpoveda/"tmpXml.xml" https://chowlk.linkeddata.es/api' , (error, stdout, stderr) => {
	    	callback(stdout);	        
	...
	function execute_err(command, callback) {				
	    var a = exec('curl -F data=@/Users/mpoveda/"tmpXml.xml" https://chowlk.linkeddata.es/errors' , (error, stdout, stderr) => {
	    	callback(stdout);			        
